                ...
                <!--<Subscribe attrs={cell.attrs()} let:attrs>-->
                    <td {...cell.attrs()} class="{cell.id}">
                        ...
                        {:else if cell.id == '__view'}
                            <a href="#" on:click|preventDefault|stopPropagation={ () => goToPos(cell.value.seqid, cell.value.start, cell.value.end) }>view</a>
                        {:else}
