...
const canvasOnScrollDebounced = debounce((scrollTop) => {
    let _start = parseInt(scrollTop);
...
<div class="track minimap" style="position: absolute; top: 0px; left: 0px; z-index: 900; height: 400px; width: 100%;">
    ...
    <div id="test" on:scroll|stopPropagation={ (event) => canvasOnScrollDebounced(event.target.scrollTop) } style="max-height: 399px; overflow-y: scroll; flex-grow: 1; margin-top: 1px;">
